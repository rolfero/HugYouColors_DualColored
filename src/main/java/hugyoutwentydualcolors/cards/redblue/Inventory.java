...
import hugyoutwentydualcolors.actions.InventoryAction;
...
public class Inventory extends DualCard {
    private final static CardInfo cardInfo = new CardInfo(
            "Inventory", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new InventoryAction(p, this.freeToPlayOnce, this.energyOnUse));
    }
}