...
import hugyoutwentydualcolors.powers.ProductivityPower;
import hugyoutwentydualcolors.powers.ProductivityUpgradedPower;
...
public class Productivity extends DualCard {
    private final static CardInfo cardInfo = new CardInfo(
            "Productivity", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p, p, (upgraded ? new ProductivityUpgradedPower(p, magicNumber) : new ProductivityPower(p, magicNumber)), magicNumber));
    }
}