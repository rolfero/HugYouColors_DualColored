...
import hugyoutwentydualcolors.actions.FashionBladeAction;
...
public class FashionBlade extends DualCard {
    ...
    private final static CardInfo cardInfo = new CardInfo(
            "FashionBlade", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new FashionBladeAction(p, this.freeToPlayOnce, this.energyOnUse, magicNumber));
    }
}