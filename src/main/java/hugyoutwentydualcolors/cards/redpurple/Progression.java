...
import hugyoutwentydualcolors.powers.ProgressionPower;
...
public class Progression extends DualCard {
    private final static CardInfo cardInfo = new CardInfo(
            "Progression", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p, p, new ProgressionPower(p, 1), 1));
    }
}