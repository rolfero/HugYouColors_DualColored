...
public class Training extends DualCard {
    private final static CardInfo cardInfo = new CardInfo(
            "Training", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
