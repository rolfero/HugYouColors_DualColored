...
public class ToTheHeretics extends DualCard {
    private final static CardInfo cardInfo = new CardInfo(
            "ToTheHeretics", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    private static final int SMITE = 2;

    
    public ToTheHeretics() {
