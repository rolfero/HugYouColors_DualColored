...
import hugyoucolors.powers.LoseFocusPower;
...
public class Database extends DualCard {
    private final static CardInfo cardInfo = new CardInfo(
            "Database", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
