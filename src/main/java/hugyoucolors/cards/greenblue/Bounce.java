...
public class Bounce extends DualCard {
    private final static CardInfo cardInfo = new CardInfo(
            "Bounce", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new AbstractGameAction() {
            @Override
            public void update() {
                addToTop(new GainEnergyAction(GameActionManager.totalDiscardedThisTurn));
                this.isDone = true;
            }
        });
    }
