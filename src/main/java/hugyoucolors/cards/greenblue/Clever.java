...
import hugyoucolors.actions.CleverFollowUpAction;
...
public class Clever extends DualCard {
    private final static CardInfo cardInfo = new CardInfo(
            "Clever", //Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard" with whatever your mod's ID is.
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new DrawCardAction(this.magicNumber, new CleverFollowUpAction(REDUCE)));
    }
}